...
ActiveRecord::Schema[7.1].define(version: 2025_01_19_152507) do
  ...
  create_table "matches", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "disliked_user_id", null: false
    t.boolean "liked"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["disliked_user_id"], name: "index_matches_on_disliked_user_id"
  ...
  add_foreign_key "matches", "disliked_users"
